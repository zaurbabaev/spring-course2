package az.babayev.springrest.exceptions.globalHandler;

import az.babayev.springrest.exceptions.*;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public String handleLanguageNotFoundException(LanguageNotFoundException exception) {
        return exception.getMessage();
    }

    @ExceptionHandler
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public String handleLanguageExistsException(LanguageExistsException exception) {
        return exception.getMessage();
    }
